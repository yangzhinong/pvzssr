...
namespace Shadowsocks.View
{
    public class MenuViewController
    {
        ...
        private FreeSSRForm freeSSRForm;
        private LogForm logForm;
        private string _urlToOpen;
        private System.Timers.Timer timerDelayCheckUpdate;
        private System.Timers.Timer timerReboot;
        ...
        public MenuViewController(ShadowsocksController controller)
        {
            ...
            timerDelayCheckUpdate = new System.Timers.Timer(1000.0);
            timerDelayCheckUpdate.Elapsed += timer_Elapsed;
            timerDelayCheckUpdate.Start();

            timerReboot = new System.Timers.Timer(1000.0 );
            timerReboot.Elapsed += timer_Reboot;
            timerReboot.Start();
        }

        private void timer_Reboot(object sender, System.Timers.ElapsedEventArgs e)
        {
        ...
        private void LoadMenu()
        {
            this.contextMenu1 = new ContextMenu(new MenuItem[] {
                ...
                new MenuItem("FreeSSR.site获取", new EventHandler(this.Free_SS_Site_Click)),
                new MenuItem("-"),
        ...
        void freeSSRForm_FromClose(object sender,FormClosedEventArgs e)
        {
            freeSSRForm = null;
            Util.Utils.ReleaseMemory();
        }
        ...
        private void Free_SS_Site_Click(object sender, EventArgs e)
        {
            
            if (freeSSRForm != null)
            {
                freeSSRForm.Activate();
            }
            else
            {
                
                freeSSRForm = new FreeSSRForm(controller);
                freeSSRForm.Show();
                freeSSRForm.Activate();
                freeSSRForm.BringToFront();
                freeSSRForm.FormClosed += freeSSRForm_FromClose;
            }
